...
const GlobeSection = () => {
    return (
        <div className=' container mx-auto mt-10 lg:mb-10 lg:mt-0 flex flex-col lg:flex-row  gap-5 p-2 lg:p-4 lg:min-h-[500px] rounded-lg justify-between'>
                ...
                <Globe className="lg:max-w-[600px] w-full aspect-square" />
